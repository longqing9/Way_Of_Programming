...
public class UserControllerGson extends BaseControllerGson {
...
//	@ModelAttribute
	...
	public String get(@RequestParam(required=false) String id,HttpServletResponse response) {
		...
		if (StringUtils.isNotBlank(id)){
			...
			UserUtils.setVoUser(voUser, user);
			return JsonMapper.toJsonString(voUser);
		}else{
			return JsonMapper.toJsonString(voUser);
		}
	}
	...
	public String delete(User user,HttpServletResponse response, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/sys/user/list?repage";
		}
	...
	public String info(User user, HttpServletResponse response, Model model) {
		...
		VoUser voUser=new VoUser();
		UserUtils.setVoUser(voUser, currentUser);
