...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sob/tbSob/">个人简历列表</a></li>
		<li class="active"><a href="${ctx}/sob/tbSob/form?id=${tbSob.id}">个人简历<shiro:hasPermission name="sob:tbSob:edit">${not empty tbSob.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sob:tbSob:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tbSob" action="${ctx}/sob/tbSob/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="emolument" htmlEscape="false" maxlength="30" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">期望工作地点：</label>
			<div class="controls">
				<form:input path="workaddress" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">求职地点：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">前职业月薪：</label>
			<div class="controls">
				<form:input path="salary" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">职业描述：</label>
			<div class="controls">
				<form:textarea path="jobmiaoshu" htmlEscape="false" rows="4" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">pro_descripe：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="proDuty" htmlEscape="false" rows="4" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="zsTime" htmlEscape="false" maxlength="30" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">自我评价：</label>
			<div class="controls">
				<form:textarea path="selfassess" htmlEscape="false" rows="4" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sob:tbSob:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
