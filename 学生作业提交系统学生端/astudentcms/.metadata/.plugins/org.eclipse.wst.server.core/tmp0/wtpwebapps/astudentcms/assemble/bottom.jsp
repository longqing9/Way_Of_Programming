...
<div id="StatusBar">
    ...
    <div id="StatusBar_Links">
		<a href="http://www.nyist.edu.cn/" target="_blank">南阳理工学院</a>
    </div>
	<!-- 右侧功能按钮 -->
    <div id="StatusBar_Right">
		<!-- 版本 -->
		<a href="javascript:void(0)">
			<img border="0" width="11" height="11" src="${pageContext.request.contextPath }/style/images/info.gif" /> 
			<img border="0" width="40" height="11" src="${pageContext.request.contextPath }/style/images/version.gif" />
		</a>
    </div>
</div>
