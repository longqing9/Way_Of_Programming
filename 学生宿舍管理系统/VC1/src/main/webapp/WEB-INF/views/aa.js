        ...
        var t = function() {
            ...
            oe.prototype.Base64 = {
                ...
                encode: function(e) {
                    var t, s, n, r, o, i, a, u = "",
                    c = 0;
                    for (e = oe.prototype.Base64._utf8_encode(e); c < e.length;) t = e.charCodeAt(c++),
                    s = e.charCodeAt(c++),
                    n = e.charCodeAt(c++),
                    r = t >> 2,
                    o = (3 & t) << 4 | s >> 4,
                ...
                decode: function(e) {
                    var t, s, n, r, o, i, a, u = "",
                    c = 0;
                    for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); c < e.length;) r = this._keyStr.indexOf(e.charAt(c++)),
            ...
            if (o = "webVideoCtrl" + ie, i = "webVideoCtrl" + ie, "object" != typeof e.attachEvent && I.browser().msie) {
                ...
                ae += "<script for=" + o + " event='ZoomInfoCallback(szZoomInfo)'>ZoomInfoCallback(szZoomInfo);</script>",
                ae += "<script for=" + o + "  event='GetHttpInfo(lID, lpInfo, lReverse)'>GetHttpInfo(lID, lpInfo, lReverse);</script>",
                ae += "<script for=" + o + "  event='PluginEventHandler(iEventType, iParam1, iParam2)'>PluginEventHandler(iEventType, iParam1, iParam2);</script>",
                document.write(ae)
            }
            return this
        } (),
