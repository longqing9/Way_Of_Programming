	...
	<div id="login">
		...
		<div class="wrapper">
			...
			<div class="login sign-in-htm">
				<form class="container offset1 loginform" id="form" action="${wh}/denglu" >
					<!-- 猫头鹰控件 -->
						...
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="login-username" 
									name="account" autocomplete="off" placeholder="请输入用户名" tabindex="1" maxlength="15" />
			...
			<div class="login sign-up-htm">
				<form action="${wh}/Registe" method="post" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
					...
					<div class="pad input-container">
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-username" name="account"
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-repassword" name="name" placeholder="真实姓名" maxlength="15"/>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-code" name="durmnumber" autocomplete="off" placeholder="宿舍号"/>
